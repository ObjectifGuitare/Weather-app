...
function compareWeather()
{
    ...
    let cityOneTemp;
    let cityTwoTemp;
    fetch("https://api.openweathermap.org/geo/1.0/direct?q="+cityOne.value+"&limit=1&appid=15503d995eb403b985f0761f2345534a")
    ...
    .then(objOne =>{
        ...
        .then(() =>{
            fetch("https://api.openweathermap.org/geo/1.0/direct?q="+cityTwo.value+"&limit=1&appid=15503d995eb403b985f0761f2345534a")
